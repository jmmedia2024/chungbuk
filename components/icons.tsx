...
export const UsersIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.51.056 1.02.083 1.53.083h.018a5.25 5.25 0 005.25-5.25v-.013m-10.5 0v.013a5.25 5.25 0 005.25 5.25h.018a5.25 5.25 0 005.25-5.25v-.013m-10.5-1.039a5.25 5.25 0 10-10.5 0v.013a5.25 5.25 0 005.25 5.25h.018a5.25 5.25 0 005.25-5.25v-.013" />
    </svg>
);
...
export const QuoteIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className={className}>
        <path d="M14.017 21v-7.391c0-2.908.767-4.918 2.3-5.874l.47-1.125c-1.353.66-2.92 1.624-3.416 3.032-.701-1.238-1.533-2.6-3.138-3.56L9.03 7.15c.924 1.15 1.488 2.508 1.488 4.717v9.133h3.5zm-10.5 0v-7.391c0-2.908.767-4.918 2.3-5.874l.47-1.125c-1.353.66-2.92 1.624-3.416 3.032-.701-1.238-1.533-2.6-3.138-3.56L-.01 7.15c.924 1.15 1.488 2.508 1.488 4.717v9.133h3.5z" />
    </svg>
);
